...
#
# Config file options:
#   loop_delay: float # The seconds the xenode waits before running process().
...
class HashToCsvXenode
  ...
  def process_message(msg)
    ...
    if msg
      ...
      # James: since it only accept array in parse_hash, need to make sure msg.data is an Array
      # if it's NOT an array, we will make it into an array.
      unless msg.data.is_a?(Array)
        msg.data = [msg.data]
      end
